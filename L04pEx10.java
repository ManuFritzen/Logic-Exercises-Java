...
conheceu até os sitios mais remotos e obscuros atrás de informações 
...
percebeu que, por um erro do navegador, a aba foi encerrada (sem abrir outras abas). 
...
As ações podem ser fechou (quando Péricles fechou uma aba) ou clicou 
(quando Péricles clicou em uma propaganda).

Entrada
A entrada é iniciada por uma linha contendo dois números inteiros positivos, 
N e M (0 < N, M < 500), representando o número inicial de abas e 
o número de ações de Péricles. Cada linha subsequente contém uma ação (fechou ou clicou). 
